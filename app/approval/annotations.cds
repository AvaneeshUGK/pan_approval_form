...
annotate service.tab1 with @(
    UI.Facets : [
        ...
        {
            $Type : 'UI.ReferenceFacet',
            Label : 'Attachments Internal to Pan for Approvals',
            ID : 'ATTACHMENTSINTERNALTOPANFORAPPROVERS',
            Target : 'tab1topdf/@UI.LineItem#ATTACHMENTSINTERNALTOPANFORAPPROVERS',
        },
        {
            $Type : 'UI.ReferenceFacet',
...
annotate service.PAYMENT_TERM_DETAILS with {
    To_be_certified_in_Company_by @Common.FieldControl : #ReadOnly
};
annotate service.PAYMENT_TERM_DETAILS with {
    Mandatory_Documents_OR_Submissions_for_Progress @Common.FieldControl : #ReadOnly
};
annotate service.Fvendor_responseoo with {
...
annotate service.tab1 with {
    justification @Common.FieldControl : #ReadOnly
};
...
annotate service.tab2 with {
    First_Publish_Data_DASH_same_as_sr_no_28 @Common.FieldControl : #ReadOnly
};
annotate service.tab2 with {
    Last_Publish_data_before_RA @Common.FieldControl : #ReadOnly
};
annotate service.tab2 with {
    RA_Data @Common.FieldControl : #ReadOnly
};
annotate service.tab2 with {
    Techanical_appropval_data @Common.FieldControl : #ReadOnly
};
annotate service.tab2 with {
    Client_approval_data @Common.FieldControl : #ReadOnly
};
annotate service.attachments with {
